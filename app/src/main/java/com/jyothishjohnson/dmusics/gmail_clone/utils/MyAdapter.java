...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.mailSender.setText(mArrayList.get(position).getSender());
        holder.mailSubject.setText(mArrayList.get(position).getSubject());
        ...
        holder.checkStarred.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(!mArrayList.get(position).getStarred()){
                    mArrayList.get(position).setStarred(true);
                    if(mArrayList.get(position).getStarred()) {
                        holder.checkStarred.setImageResource(R.drawable.ic_star_black_24dp);
                    }else{
                        holder.checkStarred.setImageResource(R.drawable.ic_star_border_black_24dp);
                    ...
                    mArrayList.get(position).setStarred(false);
                    if(mArrayList.get(position).getStarred()) {
                        holder.checkStarred.setImageResource(R.drawable.ic_star_black_24dp);
                    }else{
                        holder.checkStarred.setImageResource(R.drawable.ic_star_border_black_24dp);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        private ImageView checkStarred;
        ...
        MyViewHolder(View view) {
            ...
            checkStarred = view.findViewById(R.id.star);
